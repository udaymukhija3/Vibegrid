# Legacy Tier-3 plan — superseded

This document used to plan polish for the hidden-category product: per-puzzle
OG rendering, evergreen group generation, archive supply, and answer-oriented
admin tooling. That plan is no longer active.
...
Do not implement tasks from an older copy of this plan. Use
`product-vision.md`, `decision-register.md`, `engineering-roadmap.md`, and
`launch-sprint-plan.md`.
